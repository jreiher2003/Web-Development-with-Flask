...
GMAPS_URL = "http://maps.googleapis.com/maps/api/staticmap?size=580x300&zoom=3&sensor=false&markers=26.876,-82.2681&markers=40.7128, -74.0059"
def gmaps_img():
...
def hello():
    ...
    # points = filter(None, (a.coords for a in all_art))
    img_url = None
    img_url = gmaps_img()
